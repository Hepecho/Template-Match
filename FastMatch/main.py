...
def main(args):
    ...
    fast_match = FAsTMatch(0.15, 0.85, False, 0.5, 2.0)  # _, _, 0.5, 2.0
    start = time.time()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--image_file', default='../example/image/image2.png', help='Input image file', type=str)
    parser.add_argument('--template_file', default='../example/image/image1c.png', help='Template image file', type=str)
